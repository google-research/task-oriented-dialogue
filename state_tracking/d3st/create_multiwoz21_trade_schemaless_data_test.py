...
from state_tracking.d3st import create_multiwoz21_trade_schemaless_data
...
class CreateMultiwozSchemalessDataTest(tf.test.TestCase):
  ...
  def setUp(self):
    ...
    tf.io.gfile.copy(
        ...
        os.path.join(self._temp_dir, 'train_dials.json'))
    tf.io.gfile.copy(
    ...
    _touch_empty_file(os.path.join(self._temp_dir, 'dev_dials.json'))
    _touch_empty_file(os.path.join(self._temp_dir, 'test_dials.json'))
