...
blaze run //learning/brain/research/babelfish/dialog/tools/\
show_dont_tell:create_sgd_sdt_data -- \
--output_path=/path/to/file.tsv --prompt_indices=0 \
--mcq_cat_vals --subdirs=train
"""
